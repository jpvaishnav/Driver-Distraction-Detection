...
def svm():
    mydata = pd.read_csv(r"F:\Trimester2\BTP\BTP\train.csv", header=None)
    ...
    #r=tree.export_text(svclassifier)
    #print(r)
...
def predict(X, imgSeq):
    ...
    imgLabel = pd.read_csv(r"F:\Trimester2\BTP\BTP\images\ImageLabels.csv")
    imgLabel["SVM"] = ''
...
imgs = glob.glob(r"F:\Trimester2\BTP\BTP\images\test\*.jpg")
